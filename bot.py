...
client = OpenAI(
    ...
    base_url="https://api.b.ai/v1"          # ← B.AI uchun to‘g‘ri manzil
)
...
def get_user_lock(user_id):
    ...
    Gemini/DeepSeek'ga ketib qolishining oldini oladi.
    """
...
def reply(message):
    ...
    with lock:
        ...
        try:
            ...
            # =================================================
            # XATO BO'LGANDA USER XABARINI HISTORY'DAN
            # OLIB TASHLASH
            # =================================================
