...
def get_user_lock(user_id):
    ...
    DeepSeek'ga ketib qolishining oldini oladi.
    """
...
# =========================================================
# UZUN JAVOBNI REPLY QILIB YUBORISH
# =========================================================
...
def reply(message):
    ...
    with lock:
        ...
        try:
            ...
            # =================================================
            # TELEGRAMGA REPLY QILIB YUBORISH
            #
            # message.message_id orqali Aizo aynan
            # foydalanuvchining savoliga reply qiladi.
            # =================================================
            ...
            # =================================================
            # XATO XABARINI HAM REPLY QILISH
            # =================================================
